  ...
  return (
    <section className="section">
      <div className="section-heading">
        ...
        <p style={{ color: "#e6b84a", fontSize: "0.85rem", marginTop: "0.25rem" }}>🔊 Voice option is at the bottom of this page — look for the "Read page aloud" button.</p>
      ...
      <div className="species-grid">
        {reptiles.map((r) => {
          ...
          return (
            <div key={r.slug} className="species-tile stagger-1" style={{ minHeight: "340px", position: "relative", overflow: "hidden", background: `linear-gradient(135deg, ${colorTheme.bg}30, #120520)` }}>
