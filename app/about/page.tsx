    ...
    <section className="section">
      <div style={{ maxWidth: "720px", margin: "0 auto" }}>
        ...
        <p className="page-intro" style={{ marginBottom: "2rem" }}>
          Reptile Haven is a mobile-first care site with interactive schedule tracking, health-risk indicators, and nested species guides. Each guide includes habitat minimums, lighting requirements, humidity targets, substrate recommendations, and feeding schedules — all tied to a lightweight profile system that saves directly to your browser.
        </p>
